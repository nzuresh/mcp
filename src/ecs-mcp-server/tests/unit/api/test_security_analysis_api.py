...
class TestSecurityAnalysisAPI:
    ...
    def test_security_analyzer_phase1_service_mesh_security(self):
        ...
        service_connect_insecure = {
            ...
            "serviceConnectConfiguration": {
                ...
                "services": [
                    {
                        "clientAliases": [{"port": 8080}]  # Non-HTTPS port
                    }
                ],
            },
        }
    ...
    def test_security_analyzer_phase2_integration_comprehensive(self):
        ...
        # Create a comprehensive service configuration that would trigger both Phase 1 and Phase 2 checks
        service = {
            "serviceName": "test-service",
            "enableExecuteCommand": True,
            "capacityProviderStrategy": [{"capacityProvider": "FARGATE_SPOT", "weight": 1}],
        ...
        cluster_data = {
            "cluster": {
                "clusterName": "test-cluster",
                "configuration": {
                    "executeCommandConfiguration": {}  # Missing KMS and logging
                },
            }
        }
